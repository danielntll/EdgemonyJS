...
import { localStorage } from "./localSt.js";
...
const completeTodo = async (index, item) => {
  todoList[index].completed = true;
  localStorage.add(todoList);
};
...
todoList = localStorage.read();
console.log("AAAA: ", todoList);
buildContent();
